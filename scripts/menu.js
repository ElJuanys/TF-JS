...
function mostrarPlatos(platos){
                ...
                <div class="row">
                    <article class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" value="${plato.id}">Agregar al Carrito</button>
                        </div>
                    </article>
                </div> 
            </div>       
    ...
    for(const categoria in categoriaActual){
        ...
        /** para agregar evento a cada boton */
        categoriaActual[categoria].querySelectorAll('button').forEach(button => {
            button.addEventListener('click', () => {
                agregarAlCarrito(button.value);
                console.log(carrito)
            });
        })
    }
